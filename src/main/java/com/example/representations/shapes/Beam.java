...
public class Beam implements Shape
{
    ...
    public Beam(Coord location, double length, double angle, double width)
    {
    ...
    public Beam(Coord start_location, Coord end_location, double length, double angle, double width)
    {
